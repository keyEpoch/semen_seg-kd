...
class TrainDataset(torchdata.Dataset):
    def __init__(self, odgt, opt, max_sample=-1, batch_per_gpu=1, use_aug = False, ignore_label = 19):
...
class ValDataset(torchdata.Dataset):
    def __init__(self, odgt, opt, max_sample=-1, start_idx=-1, end_idx=-1, use_aug = False, ignore_label = 255):
        self.root_dataset = opt.root_dataset
        self.imgSize = opt.imgSize
        self.imgMaxSize = opt.imgMaxSize
        # max down sampling rate of network to avoid rounding during conv or pooling
